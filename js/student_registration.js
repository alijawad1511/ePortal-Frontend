...
function validateStudentRegistration(){
    ...
    if(studentCnic.length!=15 || studentCnic.charAt(5)!='-' || studentCnic.charAt(13)!='-' ){
        console.log("cnic");
        document.getElementById('studentCnicError').innerHTML = `<i class="fas fa-exclamation-circle text-danger"></i> Invalid CNIC! Please provide correct CNIC as shown in Hint`;
        return false;
    }
    else{
    ...
    if(parentCnic.length!=15 || parentCnic.charAt(5)!='-' || parentCnic.charAt(13)!='-' ){
        console.log("pcnic");
